...
│   ├── services/
│   │   ├── llm_service.py       # LiteLLM wrapper, tool registry, multi-provider support
...
├── requirements.txt             # Dependencies (includes gunicorn, psycopg2-binary)
├── .env.example                 # Example env vars with multi-provider LLM docs
└── README.md
```
